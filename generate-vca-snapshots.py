'''
important! :
    - This file reads data from 'https://raw.githubusercontent.com/Project-Catalyst/vca-tool/master/src/assets/data/assessments.csv' (ASSESSMENTS_KEYS_PATH)
        Code errors and data inconsistencies may happen if the repositories are not concisely updated
    - This code builds on the data from < snapshots/ca-backend_snapshot.json > (generated by generate-ca-snapshots.py)
        The non-conformidy of such file may result in code errors and data inconsistencies
'''
...
# data paths
SCRIPT_URL = 'https://github.com/Project-Catalyst/vca-tool-backend/blob/master/generate-vca-snapshots.py'
